...
nrow(only_in_nest_data_FP) + nrow(only_in_threat_data_FP) +
nrow(only_in_nest_data_MP) + nrow(only_in_threat_data_MP) +
nrow(only_in_nest_data_BSC) + nrow(only_in_threat_data_BSC)
