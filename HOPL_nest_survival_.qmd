...
lucinda_nest_import <-
  function(year_1, year_2, file_name, site, extra_text = NULL, 
    ...
    if(is.null(extra_text)){
      file <- 
        read_excel(paste0("data/Jasmin/", file_name), 
...
suppressMessages(
  bind_rows(
  read_excel(paste0("data/Jasmin/", "MP Nesting Summary All Years - final.xlsx"), 
...
# Save the workbook
saveWorkbook(MP_nest_issues, here("data/Jasmin/nest_issues_commented/MP_nest_data_issues_280525.xlsx"), overwrite = TRUE)
```
...
nest_data_MP <-
  bind_rows(
    lucinda_nest_import(year_1 = "2023", year_2 = "2024", 
                        file_name = "MP Nesting Summary All Years - final.xlsx", site = "MP",
                        first_found_date_col = 12, 
                        last_alive_date_col = 32, 
                        last_checked_col = 38),
    lucinda_nest_import(year_1 = "2022", year_2 = "2023", 
                        file_name = "MP Nesting Summary All Years - final.xlsx", site = "MP",
                        first_found_date_col = 12, 
                        last_alive_date_col = 32, 
                        last_checked_col = 38),
    lucinda_nest_import(year_1 = "2021", year_2 = "2022", 
                        file_name = "MP Nesting Summary All Years - final.xlsx", site = "MP",
                        first_found_date_col = 12, 
                        last_alive_date_col = 32, 
                        last_checked_col = 38),
...
MP_nest_data_issues %>% filter(nest_ID %in% MP_nests_with_issues$nest_ID)
...
nest_data_BSC <-
  bind_rows(
    lucinda_nest_import(year_1 = "2020", year_2 = "2021", 
                        first_found_date_col = 11, last_alive_date_col = 29, last_checked_col = 36,
...
# Save the workbook
saveWorkbook(sites_diff_FP_xl, here("data/sites_diff_FP_xl.xlsx"), overwrite = TRUE)
...
# Save the workbook
saveWorkbook(sites_diff_MP_xl, here("data/sites_diff_MP_xl.xlsx"), overwrite = TRUE)
...
# Save the workbook
saveWorkbook(sites_diff_BSC_xl, here("data/sites_diff_BSC_xl.xlsx"), overwrite = TRUE)
...
```{r}
nest_data_with_threat_data_7d_ %>% mutate(season_site = paste(season, site, sep = "_")) %>% 
  filter(str_detect(site, "Middleton")) %>% pull(season_site)

only_in_nest_data_FP %>% mutate(season_site = paste(season, site, sep = "_")) %>% 
  filter(str_detect(site, "Middleton")) %>% pull(season_site)

only_in_threat_data_FP %>% mutate(season_site = paste(season, site, sep = "_")) %>% 
  filter(str_detect(site, "Middleton")) %>% pull(season_site)
```
